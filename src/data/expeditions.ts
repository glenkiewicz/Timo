...
export const EXPEDITIONS: Expedition[] = [
  // === LIGA REGIONALNA / BIOMÓW ===
  {
    ...
    roster: [
      ...
      'vole', 'water_shrew', 'polecat', 'musk_rat', 'european_hamster',
      'crossbill', 'siskin', 'goldcrest', 'waxwing', 'kingfisher',
      'black_woodpecker', 'eagle_owl_white', 'hawfinch', 'serin',
      'grebe_great', 'cicada', 'millipede', 'mole_eu', 'dormouse_garden',
      'kestrel', 'peacock_butterfly', 'tick', 'axolotl_pink', 'robin_european',
      'nuthatch', 'raccoon_dog', 'fire_belly_toad', 'crane_grey', 'barn_owl',
    ],
  },
  {
    id: 'savanna',
    ...
    description_pl: 'Lornetka spakowana! Słońce, akacje, pustynne piaski i wielkie zwierzęta na horyzoncie.',
    hero_emoji: '🦁',
    ...rewards(6),
    mode: 'expert',
    roster: [
      'lion', 'elephant', 'giraffe', 'zebra', 'flamingo', 'ostrich',
      'crocodile', 'leopard', 'cheetah', 'hippo', 'rhino', 'antelope', 'gnu',
      'hyena', 'jackal', 'meerkat', 'gazelle', 'buffalo', 'warthog', 'vulture',
      'termite', 'fennec', 'mongoose', 'dik_dik', 'impala', 'kudu', 'eland',
      'oryx', 'springbok', 'african_wild_dog', 'aardvark', 'rock_hyrax',
      'serval', 'aardwolf', 'ibis', 'marabou', 'locust', 'pangolin', 'ratel',
      'sitatunga', 'caracal', 'genet', 'zebra_grevyi', 'addax',
      'secretary_bird', 'mamba', 'camel_spider', 'aardwolf_kenya',
      'honey_badger', 'crowned_crane', 'sand_cat',
    ],
  },
  {
    id: 'ocean',
    ...
    roster: [
      ...
      'sardine', 'halibut', 'sturgeon', 'hermit_crab', 'coconut_crab', 'krill',
      'barnacle', 'clam', 'oyster', 'sea_urchin', 'sea_anemone', 'orca_killer',
      'blue_whale_pygmy', 'humpback', 'right_whale', 'gray_whale', 'dugong',
      'sea_lion', 'elephant_seal', 'leopard_seal', 'angler_fish', 'parrotfish',
      'wrasse', 'lionfish', 'stonefish', 'blobfish', 'pufferfish',
      'porcupinefish', 'mola_giant', 'mantis_shrimp', 'horseshoe_crab',
      'nautilus', 'giant_squid', 'vampire_squid', 'cone_snail', 'sea_cucumber',
      'sea_slug', 'mantis_shrimp_peacock', 'atlantic_puffin', 'booby',
      'moonjellyfish', 'octopus_blue_ring', 'crab_japanese_spider', 'flatworm',
      'sea_otter', 'great_white', 'albatross',
    ],
  },
  {
    id: 'farm',
  ...
  },
  {
    id: 'jungle',
    tag: 'jungle',
    title: 'Tropikalna dżungla',
    description_pl: 'Lianki, ryki, kolorowe pióra. Timo rusza w gęstwinę tropików Ameryki, Afryki i Azji.',
    hero_emoji: '🌴',
    ...rewards(6),
    mode: 'expert',
    roster: [
      'tiger', 'parrot', 'chimpanzee', 'gorilla', 'crocodile', 'orangutan',
      'jaguar', 'sloth', 'lemur', 'mandrill', 'anteater', 'capybara', 'gibbon',
      'macaque', 'ocelot', 'toucan', 'piranha', 'eel_electric', 'cobra',
      'python', 'anaconda', 'chameleon', 'iguana', 'boa', 'stick_insect',
      'termite', 'tarantula', 'bird_eater', 'sun_bear', 'sloth_bear', 'langur',
      'binturong', 'asian_elephant', 'macaw', 'gharial', 'saltwater_croc',
      'basilisk', 'poison_frog', 'tree_frog', 'caecilian', 'okapi', 'pangolin',
      'bongo', 'aye_aye', 'tapir', 'proboscis_monkey', 'clouded_leopard',
      'binturong_indo', 'dhole', 'jaguarundi', 'coati', 'paca', 'tamarin',
      'marmoset', 'giant_otter', 'quetzal', 'hornbill', 'bird_of_paradise',
      'toucan_keel', 'shoebill', 'discus', 'arowana', 'king_cobra', 'matamata',
      'softshell_turtle', 'glass_frog', 'mantella', 'rhinoceros_beetle',
      ...
      'hummingbird', 'harpy_eagle', 'fossa', 'tarsier', 'caiman',
    ],
  },
  {
    id: 'arctic',
    tag: 'arctic',
    title: 'Lodowe krainy',
    description_pl: 'Śnieg, lód i polarne światło — od Arktyki aż po Antarktydę. Kto przetrwa tę zimę?',
    hero_emoji: '❄️',
    ...rewards(5),
    mode: 'expert',
    roster: [
      'polar_bear', 'penguin_emperor', 'seal', 'walrus', 'arctic_fox',
      'reindeer', 'musk_ox', 'lemming', 'snowy_owl', 'narwhal',
      ...
      'adelie_penguin', 'gentoo_penguin', 'chinstrap_penguin', 'skua',
      'king_crab',
    ],
  },
  {
    ...
    description_pl: 'Koale, kangury, kiwi i dziwactwa, których nie ma nigdzie indziej.',
    hero_emoji: '🦘',
    ...rewards(4),
    mode: 'expert',
    roster: [
      ...
      'giant_weta', 'kiwi', 'penguin_little', 'numbat', 'bilby', 'bandicoot',
      'wallaby', 'tree_kangaroo', 'dingo', 'kookaburra', 'tiger_snake',
      'funnel_web_spider', 'kea', 'tuatara',
    ],
  },
  {
    id: 'night_forest',
    ...
    description_pl: 'Latarka w łapę! Po zmroku budzą się zupełnie inne zwierzęta.',
    hero_emoji: '🌙',
    ...rewards(6),
    mode: 'expert',
    roster: [
      'owl', 'wolf', 'fox', 'hedgehog', 'spider', 'lynx', 'badger', 'marten',
      'stoat', 'weasel', 'field_mouse', 'bat', 'hyena', 'ocelot', 'porcupine',
      'eagle_owl', 'firefly', 'moth', 'cockroach', 'scorpion', 'tarantula',
      'dormouse', 'aardvark', 'aardwolf', 'raccoon', 'opossum',
      'tasmanian_devil', 'cockroach_asian', 'atlas_moth', 'black_widow',
      'wildcat', 'vole', 'polecat', 'sable', 'aye_aye', 'genet',
      'eagle_owl_white', 'dormouse_garden', 'flying_squirrel', 'skunk',
      'armadillo', 'barn_owl', 'nightjar', 'honey_badger', 'aardwolf_kenya',
      'kakapo',
    ],
  },
  {
    ...
    roster: [
      ...
      'clouded_leopard', 'serow', 'takin', 'dhole', 'musk_deer', 'vicuna',
      'guanaco', 'wolverine', 'snub_nosed_monkey', 'bald_eagle',
      'giant_salamander', 'markhor', 'argali', 'bharal',
    ],
  },
  {
    id: 'home_pets',
    ...
    roster: [
      ...
      'cricket_house', 'koi', 'gerbil', 'chinchilla', 'guppy', 'betta',
      'axolotl', 'red_eared_slider',
    ],
  },
  ...
  // === LIGA TEMATYCZNA — nowe 10 ===
  {
    ...
    roster: [
      ...
      'eagle_owl_white', 'shoebill', 'secretary_bird', 'angler_fish',
      'arowana', 'king_cobra', 'mamba', 'matamata', 'alligator_snapping',
      'praying_mantis_giant', 'camel_spider', 'whip_scorpion', 'mantis_shrimp',
      'giant_squid', 'cone_snail', 'mantis_shrimp_peacock', 'bald_eagle',
      'octopus_blue_ring', 'reticulated_python', 'komodo_juvenile',
      'aardwolf_kenya', 'orb_weaver', 'sun_spider',
    ],
  },
  {
    id: 'insects',
    ...
    roster: [
      ...
      'fly', 'cricket', 'grasshopper', 'dragonfly', 'mayfly', 'firefly',
      'moth', 'cockroach', 'mantis', 'stick_insect', 'beetle', 'stag_beetle',
      'termite', 'cockroach_asian', 'cricket_house', 'hornet', 'flea', 'louse',
      'caterpillar', 'locust', 'silk_moth', 'atlas_moth', 'rhinoceros_beetle',
      'hercules_beetle', 'praying_mantis_giant', 'jewel_beetle',
      'walking_stick', 'atlas_butterfly', 'blue_morpho', 'monarch', 'cicada',
      'treehopper', 'giant_weta', 'goliath_beetle', 'peacock_butterfly',
      'morpho_blue', 'monarch_butterfly',
    ],
  },
  {
    id: 'freshwater',
    ...
    roster: [
      ...
      'zander', 'roach', 'crayfish', 'catfish_polish', 'bream', 'chub',
      'crucian', 'burbot', 'axolotl_pink', 'asp', 'rudd', 'grayling',
      'brook_trout', 'smelt', 'otter', 'beaver', 'kingfisher', 'grebe_great',
      'grass_snake', 'fire_belly_toad', 'water_strider', 'sun_spider',
    ],
  },
  {
    id: 'reptiles',
  ...
  },
  {
    ...
    roster: [
      ...
      'fire_belly_toad', 'spadefoot_toad',
    ],
  },
  {
    id: 'songbirds',
    ...
    mode: 'expert',
    roster: [
      'swallow', 'sparrow', 'tit', 'blackbird', 'nightingale', 'canary',
      'finch', 'bullfinch', 'goldfinch', 'thrush', 'mazurek', 'great_tit',
      'starling', 'lark', 'crossbill', 'siskin', 'goldcrest', 'waxwing',
      'hawfinch', 'serin', 'robin_european', 'nuthatch', 'wagtail',
      'treecreeper',
    ],
  },
  {
    id: 'monkeys',
    tag: 'monkeys',
    title: 'Małpy i lemury',
    description_pl: 'Inteligentni krewniacy człowieka — małpy, lemury i inne naczelne.',
    hero_emoji: '🐒',
    ...rewards(4),
    mode: 'expert',
    roster: [
      ...
      'tamarin', 'marmoset', 'snub_nosed_monkey', 'indri', 'sifaka', 'galago',
      'tarsier',
    ],
  },
  {
    ...
    tag: 'big_cats',
    title: 'Dzikie koty',
    description_pl: 'Królowie dżungli i sawanny oraz ich mniejsi kuzyni. Cicha siła w pasiastym i cętkowanym futrze.',
    hero_emoji: '🐯',
    ...rewards(5),
    mode: 'expert',
    roster: [
      ...
      'clouded_leopard', 'jaguarundi', 'fishing_cat', 'pallas_cat', 'sand_cat',
      'margay',
    ],
  },
  {
    ...
    roster: [
      ...
      'reticulated_python', 'giant_salamander',
    ],
  },
  {
    id: 'herbivores',
    ...
    roster: [
      ...
      'reindeer_svalbard', 'gerbil', 'chinchilla', 'saola', 'snow_fox',
    ],
  },
  ...
  },
  {
    ...
    inspirationRoster: [
      ...
      'orangutan', 'chimpanzee', 'poison_frog', 'macaw', 'piranha', 'iguana',
  ...
  },
  {
    ...
    inspirationRoster: [
      ...
      'wolf', 'lynx', 'firefly', 'scorpion', 'tarantula', 'eagle_owl',
      'marten', 'barn_owl', 'aye_aye', 'cockroach',
    ],
  },
  {
    id: 'big_animals',
  ...
  },
  {
    ...
    inspirationRoster: [
      ...
      'squirrel', 'hamster', 'lion', 'tiger', 'koala', 'otter', 'panda',
  ...
  },
  {
    ...
    description_pl: 'Owady, pająki, ślimaki i inne małe stworzonka.',
    hero_emoji: '🐝',
    ...rewards(10),
    mode: 'guided',
    inspirationRoster: [
  ...
  },
  {
    ...
    mode: 'guided',
    inspirationRoster: [
      'kangaroo', 'frog', 'rabbit', 'hare', 'wallaby', 'cricket',
  ...
  },
  {
    ...
    description_pl: 'Zwierzęta w paski, kropki i cętki.',
    hero_emoji: '🐅',
    ...rewards(10),
    mode: 'guided',
    inspirationRoster: [
      ...
      'ladybug', 'numbat', 'tapir', 'salamander', 'fire_salamander',
    ],
  },
  {
    id: 'long_nose',
  ...
  },
  {
    ...
    inspirationRoster: [
      'trex', 'brachiosaurus', 'velociraptor', 'triceratops', 'stegosaurus',
      'mammoth', 'sabretooth', 'dragon', 'unicorn', 'phoenix', 'mermaid',
      'kraken', 'yeti', 'bigfoot', 'nessie', 'sphinx', 'griffin', 'coelacanth',
    ],
  },
  {
    id: 'shelled',
